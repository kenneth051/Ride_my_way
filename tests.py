...
class FlaskTestCase(unittest.TestCase):
    ...
    def test_Creat_A_Ride(self):
        tester = APP.test_client(self)
        response = tester.post('/v1/create_ride', data="data",content_type="application/json")
    ...
    def test_Returned_data(self):
        ...
        res = tester.post('/v1/ride/3/request',content_type="application/json")
        self.assertEqual(res.status_code, 400)
        
        res = tester.post('/v1/ride/u/request',data={"Id":7},content_type="application/json")
        self.assertEqual(res.status_code, 404)
        self.assertIn(b"use a valid URL",res.data)
